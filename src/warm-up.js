...
// ### Referenced: https://www.w3schools.com/jsref/jsref_substr.asp ###
var sequel = title.substr(0,20) + " Prisoner of Azkaban";
...
if (pages < 1000) {
  console.log("I could read this in a day");
...
var books = ["How to be Happy", "Fun With JavaScript", "It's OK to be Human", "The Mindset of Champions", "Coding Chronicles"];
